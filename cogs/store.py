...
class StoreView(discord.ui.View):
    def __init__(self):
        super().__init__(timeout=None) # أزرار دائمة للأبد بدون انتهاء
...
class Store(commands.Cog):
    ...
    async def store_panel(self, interaction: discord.Interaction):
        ...
        file = discord.File("store.png", filename="store.png")
        await interaction.response.send_message(file=file, embed=embed, view=StoreView())
