...
class ColorSelectView(discord.ui.View):
    ...
    @discord.ui.select(
        ...
        min_values=1,
        max_values=1,
        custom_id="suggestion_color_select_v4",
        options=[
...
class MainPanelView(discord.ui.View):
    ...
    @discord.ui.button(label="شارك فكرتك", style=discord.ButtonStyle.primary, custom_id="main_share_idea_btn_v4", emoji="💡")
...
class SuggestionActionView(discord.ui.View):
    ...
    @discord.ui.button(label="👍 تأييد", style=discord.ButtonStyle.success, custom_id="sug_upvote_btn_v4")
    ...
    @discord.ui.button(label="👎 معارضة", style=discord.ButtonStyle.danger, custom_id="sug_downvote_btn_v4")
